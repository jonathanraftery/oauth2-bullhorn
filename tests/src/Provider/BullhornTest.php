<?php namespace JonathanRaftery\OAuth2\Client\Test\Provider;

use JonathanRaftery\OAuth2\Client\Provider\Bullhorn;
...
class BullhornTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetAuthorizationUrl()
    {
        ...
        $this->assertEquals('auth.bullhornstaffing.com', $uri['host']);
